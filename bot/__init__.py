...
REQD_PERMISSIONS = "https://t.me/@MovieMess"
SUPPORT_CHAT = "https://t.me/MovieMess"
""" strings to be used in the bot """
START_MESSAGE = get_config("START_MESSAGE", (
    "<b>𝗛𝗲𝘆 𝗗𝗲𝗮𝗿!🙋 This Is @KS_DelAllBot</b> "
    "\n\n"
    f"<b>To use me Please Give <a href='{REQD_PERMISSIONS}'>These Permission's</a> & Follow These Steps 👇🏻👇🏻</b>"
    "\n\n"
    f"➪ <b>Send </b><b>/delallmsgs</b> <b>if you want all the messages to be deleted</b>"
    "\n\n"
    f"➪ <b>Send </b><b>/delfrom</b> <b>&amp; </b><b>/delto</b> <b>before using </b><b>/delsel</b> <b>in reply to a message if you want to delete that and all subsequent messages.</b>"
    "\n\n"
    f"In case of issues,join 👉 <a href='{SUPPORT_CHAT}'>📬 Support Group </a> 👈"
    "\n\n"
    f" <b>📮Movie Channel📮 : @MovieMess</b>"
))
START_COMMAND = get_config("START_COMMAND", "start")
DEL_ALL_COMMAND = get_config("DEL_ALL_COMMAND", "delallmsgs")
BEGINNING_DEL_ALL_MESSAGE = get_config("BEGINNING_DEL_ALL_MESSAGE", (
    "Trying to delete all messages. U Must Wait..❕❗"
))
...
BEGINNING_SEL_DEL_MESSAGE = get_config("BEGINNING_SEL_DEL_MESSAGE", (
    "Trying to delete your selected messages. U Must Wait..❕❗"
))
